...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        modo.setText(
                "<html><center><font face='Century Gothic' size = '2' color='white'><b>Consultas fijas desactivadas");
        modo.setToolTipText(
                "<html><center><font face='Century Gothic' size = '4' color='orange'><b>Convierte todas las casillas de<br>seleccion multiple en<br>radiobuttons para seleccion fija<br>y viceversa");
        ...
        Estractoselect.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Estrato 1", "Estrato 2", "Estrato 3", "Estrato 4", "Estrato 5", "Estrato 6" }));
        ...
        B1Layout.setHorizontalGroup(
                B1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(B1Layout.createSequentialGroup()
                                .addGap(26, 26, 26)
                                .addComponent(añoe, javax.swing.GroupLayout.PREFERRED_SIZE, 186,
        ...
        B1Layout.setVerticalGroup(
                B1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(B1Layout.createSequentialGroup()
                                .addGap(207, 207, 207)
                                .addComponent(añoe, javax.swing.GroupLayout.PREFERRED_SIZE, 54,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4Layout.setHorizontalGroup(
                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGap(42, 42, 42)
                                .addComponent(informe1, javax.swing.GroupLayout.PREFERRED_SIZE,
        ...
        barraRegistroLectura
                .setToolTipText("Puntos de lectura critica\nporcentaje de personas\npor X cantidad de puntos");
        ...
        barraRegistroMatematica
                .setToolTipText("Puntos de matematica\nporcentaje de personas\npor X cantidad de puntos");
        ...
        jButton2.setToolTipText(
                "<html>Cantidad de personas<br>Con ese puntaje<br>(79799 personas registradas<br>de forma global)");
        ...
        Limpiar.setToolTipText(
                "<html><center><font face='Century Gothic' size = '4' color='orange'><b>Limpiar graficos<br>seleccionados");
    ...
    private void modoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_modoActionPerformed
        ...
        if (modo.isSelected()) {
            ...
            modo.setText(
                    "<html><center><font face='Century Gothic' size = '2' color='white'><b>Consulta fija activadas");
            Labuenaaños();
            actionbus1();
            actionbus2();
            actionbus3();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton4ActionPerformed
        ElementosCheck[5] = 0;
        informe1.setValue(ElementosCheck[0] + ElementosCheck[1] + ElementosCheck[3] + ElementosCheck[4]
                + ElementosCheck[5] + ElementosCheck[6]);
        grafica_check_barras();
    ...
    public void grafica_barras_1() {
        ...
        // Agrega el panel del gráfico al contenedor deseado (por ejemplo, un JPanel
        // llamado grafico_barras1)
    ...
    public void grafica_check_barras() {
         ...
         * datos.setValue(Masculinocolegio, "Tipo de colegio", "Colegio masculino");
         * datos.setValue(femeninocolegio, "Tipo de colegio", "Colegio femenino");
         * datos.setValue(TodosTiposDeColegio, "Tipo de colegio",
         * "Todo tipo de colegio");
         * 
         * datos.setValue(rural, "Zona", "Rural");
         * datos.setValue(urbana, "Zona", "Urbana");
         * datos.setValue(todazona, "Zona", "Todas las zonas");
        ...
        if (modo.isSelected()) {
            ...
            RadioGeneroColegioTodos.addActionListener(e -> {
                if (RadioGeneroColegioTodos.isSelected()) {
                    int colegio2020 = calculos.Contador(informacio2020, "FEMENINO", 10)
                            + calculos.Contador(informacio2020, "MASCULINO", 10)
                            + calculos.Contador(informacio2020, "MIXTO", 10);
                    ;
                    int colegioO2019 = calculos.Contador(informacio2019, "FEMENINO", 10)
                            + calculos.Contador(informacio2019, "MASCULINO", 10)
                            + calculos.Contador(informacio2019, "MIXTO", 10);
                    ;
                    int colegio2018 = calculos.Contador(informacio2018, "FEMENINO", 10)
                            + calculos.Contador(informacio2018, "MASCULINO", 10)
                            + calculos.Contador(informacio2018, "MIXTO", 10);
                    ;
        ...
        if (modo.isSelected()) {
            ...
            RadioTodosArea.addActionListener(e -> {
                if (RadioTodosArea.isSelected()) {
                    int areaTotal = calculos.Contador(informacio2020, "URBANO", 12)
                            + calculos.Contador(informacio2018, "URBANO", 12)
                            + calculos.Contador(informacio2019, "URBANO", 12)
                            + calculos.Contador(informacio2020, "RURAL", 12)
                            + calculos.Contador(informacio2019, "RURAL", 12)
                            + calculos.Contador(informacio2018, "RURAL", 12);
        ...
        desempeñolectura1.addActionListener(e -> {
            ...
            switch (select) {
                case "1":
                    ...
                    Infolectura.setText("<html>existen " + cantidad + " Personas<br> con un desempeño de <br> " + select
                            + " en lectua critica");
                    break;
                case "2":
                    Desempeñolectura.setValue(cantidad);
        ...
        desempeñomatematica1.addActionListener(e -> {
            ...
            switch (select) {
                case "1":
                    ...
                    InfoImate.setText("<html>existen " + cantidad + " Personas<br> con un desempeño de <br> " + select
                            + " en matematica");
                    break;
                case "2":
                    Desempeñomate.setValue(cantidad);
        ...
        desempeñonaturales1.addActionListener(e -> {
            ...
            switch (select) {
                case "1":
                    ...
                    InfoInnaturales.setText("<html>existen " + cantidad + " Personas<br> con un desempeño de <br> "
                            + select + " en naturales");
                    break;
                case "2":
                    Desempeñonaturales.setValue(cantidad);
        ...
        desempeñoingles.addActionListener(e -> {
            ...
            switch (select) {
                case "A-":
                    ...
                    InfoIngles.setText("<html>existen " + cantidad + " Personas<br> con una calificacion de <br> "
                            + select + " en ingles");
    ...
    private void actualizarTotalesaños() {
        ...
        informe1.setValue(ElementosCheck[0] + ElementosCheck[1] + ElementosCheck[2] + ElementosCheck[3]
                + ElementosCheck[4] + ElementosCheck[5] + ElementosCheck[6]);
        grafica_check_barras();
    }
    // ID
    ...
    private void actualizarTotalescasillasgenerocolegio() {
        ElementosCheck[3] = informaciongeneromasculinocolegio + informaciongenerofemeninocolegio
                + informaciongeneromixtocolegio;
        informe1.setValue(ElementosCheck[0] + ElementosCheck[1] + ElementosCheck[2] + ElementosCheck[3]
                + ElementosCheck[4] + ElementosCheck[5] + ElementosCheck[6]);
        grafica_check_barras();
    }
     ...
     * ElementosCheck[6] = estracto1 + estracto2 + estracto3 + estracto4 + estracto5
     * + estracto6;
     * informe1.setValue(ElementosCheck[0]+ElementosCheck[1]+ElementosCheck[2] +
     * ElementosCheck[3]+ElementosCheck[4]+ElementosCheck[5]+ElementosCheck[6]);
     * grafica_check_barras();
     * 
     * }
     */
